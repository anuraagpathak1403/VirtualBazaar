<%@ Page Title="" Language="C#" MasterPageFile="~/Master/InternalMaster.Master" AutoEventWireup="true" CodeBehind="CategoryMaster.aspx.cs" Inherits="VirtualBazaar.MasterPage.CategoryMaster" %>
            ...
            <div class="panel panel-default panel-transparent">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <label for="txtName">Locality </label>
                                <asp:DropDownList ID="ddlLocality" Enabled="false" runat="server" CssClass="form-control input-sm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <label for="txtCategory">Category Icon</label>
            ...
            <div class="panel panel-default panel-transparent">
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                            <asp:Button ID="btnAddCategory" runat="server" Width="120px" CssClass="btn btn-danger btn-block" Text="Add Category" OnClick="btnAddCategory_Click" />
                        </div>
                    </div>
                </div>
                <div class="row" style="padding: 5px">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div>
                            <asp:GridView ID="grdvCategory" runat="server"
                                OnPreRender="grdvCategory_PreRender" ClientIDMode="Static" ShowHeaderWhenEmpty="true" EmptyDataText="No Request Found" AutoGenerateColumns="False" GridLines="None" HeaderStyle-Wrap="true"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Category">
                                        <ItemTemplate>
                                            <asp:Label ID="Label10" runat="server" CssClass="gridLabel" Text='<%#Eval("Category") %>' />
                                        </ItemTemplate>
                                        <HeaderStyle CssClass="gridStyle" />
                                        <ItemStyle CssClass="gridLabel"></ItemStyle>
                                    </asp:TemplateField>
