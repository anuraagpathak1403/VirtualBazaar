<%@ Page Title="" Language="C#" MasterPageFile="~/Master/InternalMaster.Master" AutoEventWireup="true" CodeBehind="StateMaster.aspx.cs" Inherits="VirtualBazaar.MasterPage.StateMaster" %>
            ...
            <div class="panel panel-default panel-transparent">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <label for="txtState">Country </label>
                                <asp:DropDownList ID="ddlContry" Enabled="false" runat="server" CssClass="form-control input-sm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <label for="txtCategory">State </label>
                                <asp:HiddenField ID="hdfStateID" runat="server" />
                                <asp:TextBox ID="txtState" runat="server" CssClass="form-control input-sm"></asp:TextBox>
                            </div>
                        </div>
                    </div>
            ...
            <div class="panel panel-default panel-transparent">
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                            <asp:Button ID="btnAddState" runat="server" Width="120px" CssClass="btn btn-danger btn-block" Text="Add State" OnClick="btnAddState_Click" />
                        </div>
                    </div>
                </div>
                <div class="row" style="padding: 5px">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div>
                            <asp:GridView ID="grdvState" runat="server"
                                OnPreRender="grdvState_PreRender" ClientIDMode="Static" ShowHeaderWhenEmpty="true" EmptyDataText="No Request Found" AutoGenerateColumns="False" GridLines="None" HeaderStyle-Wrap="true"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Country">
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="Label110" runat="server" CssClass="gridLabel" Text='India' />
                                        </ItemTemplate>
                                        <HeaderStyle CssClass="gridStyle" />
                                        <ItemStyle CssClass="gridLabel"></ItemStyle>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="State">
                                        <ItemTemplate>
                                            <asp:Label ID="Label10" runat="server" CssClass="gridLabel" Text='<%#Eval("StateName") %>' />
                                        </ItemTemplate>
                                        <HeaderStyle CssClass="gridStyle" />
                                        <ItemStyle CssClass="gridLabel"></ItemStyle>
                                    </asp:TemplateField>
