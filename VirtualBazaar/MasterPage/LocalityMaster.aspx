<%@ Page Title="" Language="C#" MasterPageFile="~/Master/InternalMaster.Master" AutoEventWireup="true" CodeBehind="LocalityMaster.aspx.cs" Inherits="VirtualBazaar.MasterPage.LocalityMaster" %>
            ...
            <div class="panel panel-default panel-transparent">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <asp:HiddenField ID="hdfLocationID" runat="server" />
                                <label for="txtLocality">Locality </label>
                                <asp:TextBox ID="txtLocality" runat="server" CssClass="form-control input-sm"></asp:TextBox>
                            </div>
                        </div>
                    </div>
            ...
            <div class="panel panel-default panel-transparent">
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                            <asp:Button ID="btnAddCategory" runat="server" Width="120px" CssClass="btn btn-danger btn-block" Text="Add Locality" OnClick="btnAddCategory_Click" />
                        </div>
                    </div>
                </div>
                <div class="row" style="padding: 5px">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div>
                            <asp:GridView ID="grdvLocation" runat="server"
                                OnPreRender="grdvLocation_PreRender" ClientIDMode="Static" ShowHeaderWhenEmpty="true" EmptyDataText="No Request Found" AutoGenerateColumns="False" GridLines="None" HeaderStyle-Wrap="true"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="City">
                                        <ItemTemplate>
                                            <asp:HiddenField ID="hdnLocationID" runat="server" Value='<%#Eval("LocalityID") %>' />
                                            <asp:Label ID="Label110" runat="server" CssClass="gridLabel" Text='Patna' />
                                        </ItemTemplate>
                                        <HeaderStyle CssClass="gridStyle" />
                                        <ItemStyle CssClass="gridLabel"></ItemStyle>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Locality Name">
                                        <ItemTemplate>
                                            <asp:Label ID="Label10" runat="server" CssClass="gridLabel" Text='<%#Eval("LocalityName") %>' />
                                        </ItemTemplate>
                                        <HeaderStyle CssClass="gridStyle" />
                                        <ItemStyle CssClass="gridLabel"></ItemStyle>
                                    </asp:TemplateField>
